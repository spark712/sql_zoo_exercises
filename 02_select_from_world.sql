...
SELECT name, population/1000000 AS 'population(in million)' FROM world
...
SELECT name, ROUND(population/1000000, 2) AS 'population(mil.)', ROUND(gdp/1000000000, 2) AS 'gdp(bil.)'
FROM world
WHERE continent = 'South America';
